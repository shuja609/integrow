...
if (!gotTheLock) {
  ...
  electron__WEBPACK_IMPORTED_MODULE_1__.app.on('second-instance', (event, commandLine, workingDirectory) => {
    // Someone tried to run a second instance, we should focus our window instead
    const windows = electron__WEBPACK_IMPORTED_MODULE_1__.BrowserWindow.getAllWindows();
    if (windows.length > 0) {
